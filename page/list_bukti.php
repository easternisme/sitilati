                    ...
                    <section class="panel panel-default">
                      <div class="panel-body">
                         ...
                         <?php 
                          ...
                          $nomor = 1;
                          $query = "SELECT m.*,b.* FROM tb_monitor_tindak_lanjut m,tb_bukti b WHERE m.id_audit = b.id_audit AND m.id_audit = '$id_audit' AND b.flag_del = 0 ORDER BY id_bukti ASC";              
                          $sql = mysqli_query($koneksi,$query);
                          ?>
                      ...
                      <td><a onclick="return confirm('Apakah Anda Yakin ingin menghapus data bukti <?php echo $data['nama_file'] ?> ?')" href="proses.php?id_hapus=<?php echo $data['id_bukti'] ?>" ><span class="text-danger"><i class="fa fa-trash-o" title="Hapus"></i></span></a>
                      </td>
                      </tr><?php } ?>
                      </tbody>
                    </table>
