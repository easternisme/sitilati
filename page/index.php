                          ...
                          <section class="panel panel-default">
                            <div class="panel-body">
                               ...
                               <?php 
                                ...
                                $nomor = 1;
                                $query = "SELECT m.*,u.* FROM tb_monitor_tindak_lanjut m,tb_users_bawaslu u WHERE m.auditee = u.username AND m.auditee = '$auditee' AND m.flag_del = 0 ORDER BY id_audit ASC";              
                            ...
                            <td>Mulai : <?php echo date('d-m-Y',strtotime($data['tanggal_audit_mulai'])); ?>
                              <br>Tempo : <?php echo date('d-m-Y',strtotime($data['tgl_jatuh_tempo'])); ?>
                            ...
                            <a href="update_progres.php?edit_id=<?php echo $data['id_audit'] ?>" data-toggle="ajaxModal"  ><span class="text-info"><i class="fa fa-pencil" title="Update Temuan"></i></span></a>

                            <a href="upload_bukti.php?edit_id=<?php echo $data['id_audit'] ?>" data-toggle="ajaxModal"  ><span class="text-danger"><i class="fa fa-upload" title="Upload Bukti Temuan"></i></span></a>

                            <a href="list_bukti.php?edit_id=<?php echo $data['id_audit'] ?>" data-toggle="ajaxModal"  ><span class="text-warning"><i class="fa fa-folder-open" title="List Bukti"></i></span></a>
